  ...
  try {
    const saved = await AppDataSource.transaction(async (manager) => {
      ...
      const solicitacao = manager.create(SolicitacaoBrinde, {
        ...
        subgrupo_doacao: input.subgrupo_doacao ?? undefined,
        subgrupo_doacao_outros: input.subgrupo_doacao_outros ?? undefined,
        beneficiario_doacao: input.beneficiario_doacao ?? undefined,
