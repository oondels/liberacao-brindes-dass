...
export class CatalogoBrindesGeneroSandalia1778200000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "liberacao_brinde"."user_bipagem" ALTER COLUMN "tipo_requisicao" TYPE "liberacao_brinde"."tipo_requisicao_enum"[] USING ARRAY(SELECT CASE WHEN e::text = 'sandalia' THEN 'brinde_interno' ELSE e::text END::"liberacao_brinde"."tipo_requisicao_enum" FROM unnest("tipo_requisicao") AS e)`);
        await queryRunner.query(`ALTER TABLE "liberacao_brinde"."user_admin" ALTER COLUMN "tipo_requisicao" TYPE "liberacao_brinde"."tipo_requisicao_enum"[] USING ARRAY(SELECT CASE WHEN e::text = 'sandalia' THEN 'brinde_interno' ELSE e::text END::"liberacao_brinde"."tipo_requisicao_enum" FROM unnest("tipo_requisicao") AS e)`);
