...
export class UserAdmin1777459851477 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "liberacao_brinde"."user_admin" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "matricula" bigint NOT NULL, "nome" character varying(255) NOT NULL, "tipo_requisicao" "liberacao_brinde"."tipo_requisicao_enum" array, "created_by_matricula" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c143511e72fac735b8006051e55" PRIMARY KEY ("id"))`);
